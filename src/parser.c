...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [13] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_note_list_repeat1, 1, 0, 0),
  [15] = {.entry = {.count = 1, .reusable = true}}, SHIFT(7),
  [17] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_note_object_repeat1, 2, 0, 0),
  [19] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_note_object_repeat1, 2, 0, 0), SHIFT_REPEAT(7),
  [22] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_note_list_repeat1, 2, 0, 0),
  [24] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_note_list_repeat1, 3, 0, 0),
  [26] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_note_list_repeat1, 4, 0, 0),
  ...
  [60] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_decl_list_repeat1, 2, 0, 0), SHIFT_REPEAT(2),
  [63] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_decl_list_repeat1, 2, 0, 0), SHIFT_REPEAT(10),
  ...
  [76] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_note_list_repeat1, 2, 0, 0), SHIFT_REPEAT(2),
  [79] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_note_list_repeat1, 2, 0, 0), SHIFT_REPEAT(19),
  [82] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_note_list, 1, 0, 0),
  [84] = {.entry = {.count = 1, .reusable = true}}, SHIFT(16),
  [86] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_uint, 1, 0, 0),
  [88] = {.entry = {.count = 1, .reusable = true}}, SHIFT(21),
  [90] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_command, 2, 0, 0),
  [92] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_command, 3, 0, 1),
  [94] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_command, 3, 0, 2),
  [96] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_command, 3, 0, 3),
  [98] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_command, 3, 0, 4),
  [100] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_command, 3, 0, 5),
  [102] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_command, 3, 0, 6),
  [104] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_command, 3, 0, 7),
  [106] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_command, 4, 0, 8),
  [108] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_command, 4, 0, 9),
  [110] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_command, 4, 0, 10),
  [112] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_bar, 6, 0, 11),
  [114] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_bar, 7, 0, 12),
